...
#solution for main thread is not in main loop
#import matplotlib
#matplotlib.use('Agg')
...
class CSV_log:
    ...
    def check_lims_list(self,lims):
        if type(lims) is list:
            ...
            print("noise bounds is not valid")
            return False
    ...
    def readcsv(self, fpath):
        ...
        print('reading:',str(self.headdict['logNum']))
        datdic = {}
...
#run_analysis("C:/Users/19577/Downloads/PID-Analyzer-0.52/good_tune.BBL","tmp","C:/Users/19577/Downloads/PID-Analyzer-0.52/Blackbox_decode.exe","N","auto")